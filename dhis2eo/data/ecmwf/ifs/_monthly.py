...
# IMPORTANT: THIS IS NOT ACTUALLY IFS BUT RATHER SEAS5 MMSF SEASONAL MONTHLY DATA
# ALTHOUGH SOMEHOW PART OF THE IFS SYSTEM AND SUPPOSED TO BE LOCATED IN SAME IFS FOLDER
# HOWEVER, EVEN THOUGH MMSF IS DOCUMENTED AS A VALID OPEN DATA STREAM
# ITS NOT AVAILABLE ON ANY OF THE SERVER MIRRORS, INCLUDING ON RELASE DATE 5TH AT 12:00
...
def fetch_forecast_step(client, day, step, bbox, variables):
    ...
    run_time = 12  # seasonal forecasts only released at 12
